...
/* Le bouton WhatsApp dit toujours « WhatsApp » (direction, 05/09). */
$wa_libelle = 'WhatsApp';
...
.haut { background: var(--bleu); color: var(--blanc); text-align: center; padding: 14px 20px 16px; }
.haut .maison { display: flex; align-items: center; justify-content: center; gap: 14px; text-align: left; }
.haut .logo { height: 40px; width: auto; display: block; }
/* La phrase d'accueil (direction, 05/09) : chaleureuse, sans promesse de contrôle. */
.haut .accueil { max-width: 480px; margin: 12px auto 0; font-size: 15.5px; line-height: 1.5; color: #DDE6F5; }
...
<header class="haut">
    ...
    <?php if ($piece): ?>
    <p class="accueil">Merci de votre confiance ! Vous venez de scanner une pièce sélectionnée pour votre poids lourd.</p>
    <?php endif; ?>
</header>
...
<main class="page">
    ...
    <nav class="contact" aria-label="Nous joindre">
        <?php if ($wa_url !== ''): ?>
