<?php
/**
 * LA PAGE HISTORIQUE DES MOUVEMENTS D'ORIGINE DE FOUTA — MISE DE CÔTÉ,
 * PAS SUPPRIMÉE. Le 24/08, mouvements.php est passé au squelette FPL
 * (barre de filtres, compteur + « Lignes par page », pagination, écritures
 * agrandies). Ce fichier est la page telle qu'elle était juste avant,
 * entière et fonctionnelle : mouvements-fouta-origine.php.
 * On y retrouve la recherche EN DIRECT (ajax_mouvements_live.php), non
 * reprise telle quelle par la nouvelle page (filtres à validation).
 *
...
<body>
    ...
    <div class="mv-page"
        ...
        <header class="mv-hero">
            ...
            <a href="../produits/mon-travail.php" class="mv-hero__back">
