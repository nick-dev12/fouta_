...
// Les trois autres formats. Ils emportent les MÊMES filtres que le PDF ;
// ils n'emportent pas le choix de colonnes, et c'est voulu : un PDF est un
// document qu'on met en forme, un tableur est une matière qu'on retaille
// après coup — on livre donc toutes les colonnes.
$formats_fichier = export_catalogue_fichier_formats_disponibles();
...
<body class="page-produits-export-body">
    ...
    <div class="page-produits-admin page-produits-export" data-export-total="<?php echo (int) $total_export; ?>"
        ...
        <div class="content-header dashboard-hero page-produits-hero">
            <div class="dashboard-hero-text">
                <?php /* Icône SVG intégrée (fpl_icone) : celle du CDN sortait
                         tronquée hors ligne (retour du 24/08). */ ?>
                <h1><?php echo fpl_icone('list', 20); ?> Suivi du catalogue</h1>
        ...
        <section class="produits-section page-produits-section page-produits-export-section"
            ...
            <form method="GET" action=""
                ...
                <div class="admin-filter-actions page-produits-export-filters__actions">
                    ...
                    <a href="export-catalogue-fouta-origine.php?reset=1" class="btn-filter-reset">
                    ...
                    <a class="btn-secondary"
                       href="export-catalogue-fichier.php?format=csv&amp;<?php echo htmlspecialchars($pdf_query_base, ENT_QUOTES, 'UTF-8'); ?>">
                        <i class="fas fa-file-csv"></i> CSV
                    </a>
                    <?php if (!empty($formats_fichier['xlsx'])): ?>
                    <a class="btn-secondary"
                       href="export-catalogue-fichier.php?format=xlsx&amp;<?php echo htmlspecialchars($pdf_query_base, ENT_QUOTES, 'UTF-8'); ?>">
                        <i class="fas fa-file-excel"></i> Excel
                    </a>
                    <?php endif; ?>
                    <?php if (!empty($formats_fichier['docx'])): ?>
                    <a class="btn-secondary"
                       href="export-catalogue-fichier.php?format=docx&amp;<?php echo htmlspecialchars($pdf_query_base, ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <div id="page-produits-export-wrap">
                ...
                <nav class="page-produits-pagination page-produits-export-pagination" id="page-produits-export-pagination"
                    ...
                    <a href="export-catalogue-fouta-origine.php?<?php echo htmlspecialchars(http_build_query($prev_q), ENT_QUOTES, 'UTF-8'); ?>"
                    ...
                    <a href="export-catalogue-fouta-origine.php?<?php echo htmlspecialchars(http_build_query($next_q), ENT_QUOTES, 'UTF-8'); ?>"
                        class="page-produits-pagination__link">
