...
$devis_page_has_alert = isset($_SESSION['success_message']) || !empty($error_devis) || !empty($bl_erreur);
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body>
    ...
    <div class="content-header dashboard-hero page-devis-hero">
        <div class="dashboard-hero-text">
            ...
            <h1><i class="fas fa-handshake" aria-hidden="true"></i> Devis &amp; bons de livraison</h1>
            <p class="dashboard-subtitle">Créez des devis, suivez les statuts et gérez les livraisons professionnelles (BL).</p>
        </div>
    </div>
